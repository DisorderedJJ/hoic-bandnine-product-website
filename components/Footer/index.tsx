      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap items-center gap-8 lg:justify-between lg:gap-0">
              <motion.div
                variants={{
                  hidden: {
                    opacity: 0,
                ...
                viewport={{ once: true }}
                className="animate_top w-1/2 items-center lg:w-1/4"
              >
                ...
                <p className="mb-10 mt-5">
                  Your AI companion to practice IELTS
                </p>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <p className="mb-4 w-[90%]">send your suggestions</p>
                  <a
                    href="#"
                    className="text-metatitle3 text-black dark:text-white"
                  >
                    hello@bandnine.org
                  </a>
                </motion.div>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Bandnine. All rights reserved
              </p>
            </motion.div>
